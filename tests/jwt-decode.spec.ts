...
const inputJWT =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJtaXQwMjIzIiwibmFtZSI6Ik1pdHN1cnUiLCJhZG1pbiI6dHJ1ZSwiaWF0IjoxNzQ4NTI0NzI0fQ.UqAKDsDYaUViUqKRwfaGRUDBWNxUdy1amAS-3xLh8k0'
...
test('JWT decode test', async ({ page }) => {
    ...
    const clearButton = page.locator(
        'div.card_card__headline__AWfE_:has(h4:has-text("JSON Web Token (JWT)")) div[aria-label="JWT editor toolbar"] button:has-text("Clear")'
    )
    ...
    // デコードされたJSONの内容を確認
    const jsonViewer = page.locator(
        'div[aria-labelledby="react-aria-:R5ld577majsq:-tab-decoder__payload__json"]'
    )
